server {
    ...
    location = /support-api/enable {
        ...
        proxy_read_timeout 30s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/support-enable;
    }
    location = /support-api/disable {
        ...
        proxy_read_timeout 30s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/support-disable;
    }
    location = /support-api/audit {
        ...
        proxy_read_timeout 30s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/support-audit;
    }
    location = /support-api/debug {
        proxy_connect_timeout 1s;
        proxy_send_timeout 2s;
        proxy_read_timeout 30s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/support-debug;
    }
    location = /support-api/status {
        ...
        proxy_read_timeout 30s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/support-status;
    }
    location = /support-api/notify-test {
        proxy_connect_timeout 1s;
        proxy_send_timeout 2s;
        proxy_read_timeout 30s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/support?action=notifytest;
    }
    ...
    location = /control-api/reconnect {
        ...
        proxy_read_timeout 120s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/control-reconnect;
    }
    location = /control-api/logout {
        ...
        proxy_read_timeout 120s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/control-logout;
    }
    location = /control-api/diag {
        ...
        proxy_read_timeout 120s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/control-diag;
    }
    location = /control-api/dnsdiag {
        ...
        proxy_read_timeout 120s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/control-dnsdiag;
    }
    location = /control-api/status {
        ...
        proxy_read_timeout 120s;
        add_header Cache-Control "no-store";
        proxy_pass http://127.0.0.1:25910/cgi-bin/control-status;
    }
    ...
    location = /webui {
        ...
        sub_filter '</body>' '<script>(function(){try{if(document.getElementById("nodalia-back-btn"))return;var a=document.createElement("a");a.id="nodalia-back-btn";var p=window.location.pathname||"/";var i=p.indexOf("/webui");var b=i>=0?p.slice(0,i+1):(p.endsWith("/")?p:p.slice(0,p.lastIndexOf("/")+1));b=b.replace(/\/{2,}/g,"/");a.href=b+"onboarding";a.textContent="Volver al panel Nodalia";a.style.cssText="position:fixed;left:16px;bottom:16px;z-index:2147483647;background:#0b63ce;color:#fff;padding:10px 12px;border-radius:10px;text-decoration:none;font:700 13px/1.1 Segoe UI,Noto Sans,sans-serif;box-shadow:0 8px 22px rgba(0,0,0,.25)";document.body.appendChild(a);}catch(e){}})();</script></body>';
    }
